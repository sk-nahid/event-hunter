...
const AboutUs = () => {
    return (
        <div className='lg:w-10/12 md:px-12 px-4 mx-auto '>
            ...
            <section className="grid md:grid-cols-2 items-center gap-6 p-6 bg-gray-100 rounded-xl">
                <img src={'https://i.ibb.co.com/PGh3JbKB/photo-1582213782179-e0d53f98f2ca.jpg'} alt="About us" className="w-full rounded-lg" />
                <div>
                    ...
                    <Link to="/about" className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                        Learn More
                    </Link>
                </div>
            </section>
